...
Bu dizin, C++ mülakatlarında ve pratik geliştirmede karşılaşılan temel kavramları, bellek modelini ve modern dil pratiklerini içerir.

## Konular

- [01_bellek_yonetimi.md](./01_bellek_yonetimi.md): dinamik bellek tahsisi, Small String Optimization ve nesne yerleşimi.
...
- [06_standart_oznitelikler.md](./06_standart_oznitelikler.md): C++ öznitelik mekanizması, vendor bildirimleri ve standart öznitelikler tablosu.
